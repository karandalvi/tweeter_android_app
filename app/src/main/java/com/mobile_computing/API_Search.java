...
public class API_Search extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((DatumAdapter) m_adapter).setOnItemClickListener(new DatumAdapter.DatumClickListener() {
            ...
            public void onItemClick(int position, View v) {
                ...
                toast.show();
                onSelectItem(((DatumAdapter) m_adapter).getItem(position));
            }
        });
    ...
    //Method created by Karan to start the Result Display Activity
    public void onSelectItem(Datum item){
        Intent myIntent = new Intent(getApplicationContext(), ResultDisplayActivity.class);

        Bundle myBundle = new Bundle();
        myBundle.putInt("m_id", item.id());
        myBundle.putString("m_title", item.title());
        myBundle.putString("m_date", item.date());
        myBundle.putString("m_text", item.text());
        myBundle.putString("m_imageUrl", item.imageUrl());
